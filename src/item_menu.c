...
static void Task_SortMenuHandleInput(u8 taskId);
static void Task_SortMenuCancel(u8 taskId);
...
static void Task_ItemContext_Sell(u8 taskId)
{
    ...
    else if (ItemId_GetPrice(gSpecialVar_ItemId) == 0 || ItemId_GetPocket(gSpecialVar_ItemId) == POCKET_TM_CASE)
    {
        CopyItemName(gSpecialVar_ItemId, gStringVar1);
...
static const u16 sItemsByType[ITEMS_COUNT] =
{
    ...
    */
    ...
    [ITEM_ORANGE_MAIL] = ITEM_TYPE_MAIL_ITEM,
    [ITEM_HARBOR_MAIL] = ITEM_TYPE_MAIL_ITEM,
    [ITEM_GLITTER_MAIL] = ITEM_TYPE_MAIL_ITEM,
    [ITEM_MECH_MAIL] = ITEM_TYPE_MAIL_ITEM,
    [ITEM_WOOD_MAIL] = ITEM_TYPE_MAIL_ITEM,
    [ITEM_WAVE_MAIL] = ITEM_TYPE_MAIL_ITEM,
    [ITEM_BEAD_MAIL] = ITEM_TYPE_MAIL_ITEM,
    [ITEM_SHADOW_MAIL] = ITEM_TYPE_MAIL_ITEM,
    [ITEM_TROPIC_MAIL] = ITEM_TYPE_MAIL_ITEM,
    [ITEM_DREAM_MAIL] = ITEM_TYPE_MAIL_ITEM,
    [ITEM_FAB_MAIL] = ITEM_TYPE_MAIL_ITEM,
    [ITEM_RETRO_MAIL] = ITEM_TYPE_MAIL_ITEM,
};
...
{
    AddBagSortSubMenu();
    gTasks[taskId].func = Task_SortMenuHandleInput;
}
